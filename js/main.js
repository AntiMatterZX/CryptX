...
setTimeout(function() {
    ...
    $.notify({
        ...
        title: 'Siddhant Upasani from India',
...
setTimeout(function() {
    ...
    $.notify({
        icon: 'img/user-9.png',
        title: 'Victor Mayekar from India',
...
setTimeout(function() {
    ...
    $.notify({
        icon: 'img/user-6.png',
        title: 'Parth Nachane from India',
        message: 'Recently meet with <span class="blue">Siam Ahnaf</span> to buy'
    },{
        type: 'minimalist',
        placement: {
